...
const UpdateProduct = ({match}) => {
    ...
    const errorMessage = () => {
        if(error)
        {
            return <h4 className = "text-success">Update Product Failed!</h4>
        }
    }
    ...
    return(
        <Base title = "Add Product Here!" decription = "Welcome to product creation section" className = "container bg-info p-4">
